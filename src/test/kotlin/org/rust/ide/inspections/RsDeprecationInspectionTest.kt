...
class RsDeprecationInspectionTest : RsInspectionsTestBase(RsDeprecationInspection()) {
    ...
    fun `test will be deprecated function with since and note params`() = checkByText("""
        ...
        fn main() {
            <warning descr="`foo` will be deprecated from 1.0.0: here could be your reason">foo</warning>();
        }
    """)
    ...
    //- main.rs
        ...
        fn main() {/*caret*/
            foo::<warning descr="`bar` will be deprecated from 1.0.0: here could be your reason">bar</warning>();
        }
    //- foo.rs
        #[deprecated(since="1.0.0", note="here could be your reason")]
        pub fn bar() {}
